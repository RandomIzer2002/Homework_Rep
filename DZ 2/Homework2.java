...
/*как я вижу это задания для Homework4. для сдачи на проверку необходимо назвать пакет согласно
заданию. Так же согласно описанию задач создать соответсвенно для каждой задачи свой класс Task1, Task2 и т.д.

Задача должна запускать простым запуском программы. Преподаватель не должен что-то редактировать(или раскомментировать)
в коде студента.

В данном классе код Main закоментирован и программа при запуске ничего не делает.
*/
public class Homework2 {
	public static void main(String[] args) {
		...
		// System.out.println(recursedDivision(15, 9)); //в задании сказано что программа должна считывать числа из консоли

		// Задача №3

		// System.out.println(fibonachi(8)); //в задании сказано что программа должна принимать из консоли количество чисел Фибоначчи
